...
def str2dn(dn,flags=0):
  ...
  if not dn:
    return []
  return pyldap.functions._ldap_function_call(None,_pyldap.str2dn,dn,flags)
...
def is_dn(s):
  """
  Returns True is `s' can be parsed by pyldap.dn.dn2str() like as a
