# -*- coding: utf-8 -*-
"""
pyldap.controls.pwdpolicy - classes for Password Policy controls
...
from pyldap.controls import RequestControl,ResponseControl,ValueLessRequestControl,KNOWN_RESPONSE_CONTROLS
