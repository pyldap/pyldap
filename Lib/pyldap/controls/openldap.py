"""
pyldap.controls.openldap - classes for OpenLDAP-specific controls
...
import pyldap.controls
from pyldap.controls import ValueLessRequestControl,ResponseControl
...
pyldap.controls.KNOWN_RESPONSE_CONTROLS[SearchNoOpControl.controlType] = SearchNoOpControl
...
class SearchNoOpMixIn:
  ...
  def noop_search_st(self,base,scope=pyldap.SCOPE_SUBTREE,filterstr='(objectClass=*)',timeout=-1):
    try:
