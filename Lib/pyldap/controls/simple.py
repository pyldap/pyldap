# -*- coding: utf-8 -*-
"""
pyldap.controls.simple - classes for some very simple LDAP controls
...
import struct,pyldap
from pyldap.controls import RequestControl,ResponseControl,LDAPControl,KNOWN_RESPONSE_CONTROLS
...
class ManageDSAITControl(ValueLessRequestControl):
  ...
  def __init__(self,criticality=False):
    ValueLessRequestControl.__init__(self,pyldap.CONTROL_MANAGEDSAIT,criticality=False)

KNOWN_RESPONSE_CONTROLS[pyldap.CONTROL_MANAGEDSAIT] = ManageDSAITControl
...
class RelaxRulesControl(ValueLessRequestControl):
  ...
  def __init__(self,criticality=False):
    ValueLessRequestControl.__init__(self,pyldap.CONTROL_RELAX,criticality=False)

KNOWN_RESPONSE_CONTROLS[pyldap.CONTROL_RELAX] = RelaxRulesControl
...
class ProxyAuthzControl(RequestControl):
  ...
  def __init__(self,criticality,authzId):
    RequestControl.__init__(self,pyldap.CONTROL_PROXY_AUTHZ,criticality,authzId)
