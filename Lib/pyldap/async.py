"""
pyldap.async - handle async LDAP operations
...
_searchResultTypes={
  pyldap.RES_SEARCH_ENTRY:None,
  pyldap.RES_SEARCH_RESULT:None,
  pyldap.RES_SEARCH_REFERENCE:None,
}
...
class AsyncSearchHandler:
  ...
  def processResults(self,ignoreResultsNumber=0,processResultsCount=0,timeout=-1):
    ...
    timeout
        See parameter timeout of pyldap.LDAPObject.result()
    """
    self.preProcessing()
    result_counter = 0
