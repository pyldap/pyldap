# -*- coding: utf-8 -*-
"""
pyldap.syncrepl - for implementing syncrepl consumer (see RFC 4533)
...
import pyldap.ldapobject
from pyldap.controls import RequestControl,ResponseControl,KNOWN_RESPONSE_CONTROLS
...
class SyncreplConsumer:
    ...
    def syncrepl_poll(self, msgid=-1, timeout=None, all=0):
        ...
        If timeout is specified, raises pyldap.TIMEOUT in the event of a timeout.
