...
Description:
The pyldap.sasl module provides SASL authentication classes.
...
if __debug__:
  ...
  import traceback
  from pyldap import _trace_level,_trace_file,_trace_stack_limit
...
class sasl:
    ...
    If an instance of this class is passed to pyldap's sasl_bind_s()
