"""
Demo for using pyldap.resiter.ResultProcessor
...
import pyldap,pyldap.resiter

class LDAPObject(pyldap.ldapobject.LDAPObject,pyldap.resiter.ResultProcessor):
  pass

l = LDAPObject('ldap://localhost:1390',trace_level=1)
l.protocol_version = 3
msgid = l.search('dc=stroeder,dc=de',pyldap.SCOPE_SUBTREE,'(cn=m*)')
